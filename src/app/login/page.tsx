  ...
  return (
    <div className={`min-h-screen transition-all duration-500 ease-in-out w-full ${
      ...
      <div className="p-4 md:p-6 lg:p-8 flex flex-col items-center justify-center">
        <h2 className={`text-3xl font-extrabold text-center mb-6 animate-fade-in-down bg-clip-text text-transparent ${
            theme === 'dark'
        ...
        <form onSubmit={handleSignup} className={`bg-white p-6 rounded-lg shadow-md w-96 transition-all duration-300 ease-in-out ${
